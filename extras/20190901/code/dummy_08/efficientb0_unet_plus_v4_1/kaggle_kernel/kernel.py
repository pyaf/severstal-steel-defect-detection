...
#copyfile(src = '../input/userdata/efficientnet.py', dst = '../working/efficientnet.py')
#sys.path.append('../input/userdata')
...
CHECKPOINT_FILE = '../input/userdata/00255000_model.pth'


# overwrite to local path for offline development
